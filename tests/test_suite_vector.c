...
void test_vec_clone() {
    vector_t v1 = vec(1,2);
    vector_t *v1a = vec_alloc(v1);
    vector_t *v1b = vec_clone(v1a);
    vector_t *v1c = vec_clone(v1b);
    assert(v1a != v1b);
    assert(vec_equal(*v1a, *v1b));
    assert(v1b != v1c);
    assert(vec_equal(*v1b, *v1c));
    assert(v1a != v1c);
    assert(vec_equal(*v1a, *v1c));
